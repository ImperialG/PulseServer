...
app.use(multer({dest: './public/recordings'}).single('audio'));
...
router.post('/file-upload', function (req, res) {
    ...
    var cmd = 'SMILExtract -C config/demo/demo1\_energy.conf -I ' + '../public/recordings/' + req.file.path + ' -O ' + req.file.path + '.energy.csv';
