lib_svm_path = '/root/PulseServer/libsvm-3.20/python'
import sys
import os
import re
import tempfile
...
config_file = '/root/PulseServer/openSMILE-2.2rc1/config/gemaps/GeMAPSv01a.conf'
scale_file = '/root/PulseServer/libsvm-3.20/scale_file'
